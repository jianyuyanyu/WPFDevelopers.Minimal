...
namespace WidgetsDesign.Avalonia.Controls
{
    ...
    /// <summary>
    /// BadgeControl - displays a badge overlay on its content.
    /// Usage: &lt;controls:BadgeControl Text="5"&gt;&lt;Button ... /&gt;&lt;/controls:BadgeControl&gt;
    /// </summary>
    public class BadgeControl : ContentControl
    {
        ...
        public static readonly StyledProperty<double> BadgeFontSizeProperty =
            AvaloniaProperty.Register<BadgeControl, double>(nameof(BadgeFontSize), 10);

        static BadgeControl()
        {
            IsDotProperty.Changed.AddClassHandler<BadgeControl>((c, e) =>
